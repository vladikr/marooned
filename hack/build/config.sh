...
SHIM_IMAGE_NAME=${SHIM_IMAGE_NAME:-marooned-shim}
VSOCKFWD_IMAGE_NAME=${VSOCKFWD_IMAGE_NAME:-marooned-vsockfwd}
SANDBOX_IMAGE_NAME=${SANDBOX_IMAGE_NAME:-marooned-sandbox}
KERNEL_IMAGE_NAME=${KERNEL_IMAGE_NAME:-marooned-kernel}
